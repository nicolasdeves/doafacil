        ...
        <View>
          ...
          <View style={styles.signUpSection}>
            <View style={styles.signUpButton}>
              <Text style={styles.signUpText} onPress={changeFormType}>
                {type == 'login' ? 'Registrar' : 'Voltar ao login'}
              </Text>
            </View>
          </View>
      ...
      {user && (
        <View style={styles.loggedInContainer}>
          ...
          <View style={styles.buttonCampaign}>
            <Text style={styles.buttonText} onPress={goToCreateCampaign}>
              Criar campanha
            </Text>
          </View>

          <View style={styles.buttonCampaign}>
            <Text style={styles.buttonText} onPress={goToMyCampaigns}>
              Minhas campanhas
            </Text>
          </View>
